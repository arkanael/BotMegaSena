...
namespace Bot.MegaSena.Json
{
    public class ResultadoMegaSena
    {
        ...
        public float? valor_quina { get; set; }
        public float? valor_quadra { get; set; }
        public int? acumulado { get; set; }
        public float? valor_acumulado { get; set; }
        public long? dtinclusao { get; set; }
        public string prox_final_zero { get; set; }
        public float? ac_final_zero { get; set; }
        ...
        public float? vr_estimativa { get; set; }
        public long? dt_proximo_concurso { get; set; }
        public float? vr_acumulado_especial { get; set; }
        public float? vr_arrecadado { get; set; }
